...
def test_albums_format_nicely():
    album = Album(1, "Dark Side", "1995")
    assert str(album) == "Album(1, Dark Side, 1995)"
...
def test_albums_are_equal():
    album1 = Album(1, "Dark Side", "1995")
    album2 = Album(1, "Dark Side", "1995")
...
"""
Constructs with 
    id, title, release_year, and artiest_id
"""
